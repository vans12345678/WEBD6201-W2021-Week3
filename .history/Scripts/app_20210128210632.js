...
(function(){
    ...
    {
        let projectOne = "This is a simple site to demonstrate the specified requirements for Lab 1 WEBD 6201 - Client Side Scripting"; 
        let projectOneTextElement = document.getElementById("projectOne");
        
        projectOneTextElement.textContent = introText;
        projectOneTextElement.className = "fs-5 fw-bold text-center";
    }
